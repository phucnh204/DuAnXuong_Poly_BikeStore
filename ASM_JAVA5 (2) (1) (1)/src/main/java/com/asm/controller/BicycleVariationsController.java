...
public class BicycleVariationsController {
    ...
    public String showBicycleVariations(Model model,
        ...
        request.setAttribute("view", "BicycleVariations.jsp");
...
//            String errorMessage = "Tên màu chỉ được chứa các ký tự chữ cái!";
//            model.addAttribute("error", errorMessage);
//            return "redirect:/admin/bicycle-variations?message=" + URLEncoder.encode(errorMessage, StandardCharsets.UTF_8);
//        }
