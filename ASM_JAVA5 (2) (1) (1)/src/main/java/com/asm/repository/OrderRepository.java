...
public interface OrderRepository extends JpaRepository<Orders, Integer> {
	@Query("SELECT new com.asm.dto.OrderStatusCount(o.status.nameStatus, COUNT(o.id)) " + "FROM Orders o "
...
List<Tuple> getSummaryByYesterday();
	...
	@Query("SELECT NEW com.asm.dto.ProductRevenueDTO(od.productDetail.product.name, SUM(od.quantity * od.price)) "
